...
proc ::tkcon::Init {args} {
    ...
    RCS     {RCS: @(#) $Id: tkcon.tcl,v 1.7 2005/11/12 04:07:56 kenparkerjr Exp $}
...
proc ::tkcon::InitUI {title} {
    ...
    # Rozen setting the font size to 14
    catch {font create tkconfixed -family Courier -size -14}
    catch {font create tkconfixedbold -family Courier -size -14 -weight bold}
