...
# Modified for PAGE to better handle foregrounds when using different
# colors. See ;# NEEDS WORK dark comments below. The code came from
# tk8.6.10/library in the tcl/tk distribution.
...
proc ::tk_dialog {w title text bitmap default args} {
    ...
    set bg $::vTcl(pr,bgcolor)          ;# NEEDS WORK dark
    set fg $::vTcl(pr,fgcolor)    
    
    label $w.msg -justify left -text $text \
        -foreground $fg                ;# NEEDS WORK dark
    ...
    label $w.bitmap -bitmap $bitmap -foreground $fg      ;# NEEDS WORK dark
