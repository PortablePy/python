...
package ifneeded pngtcl 1.6.37 \
    [list load [file join $dir libpngtcl1.6.37.so]]
package ifneeded tifftcl 4.1.0 \
    [list load [file join $dir libtifftcl4.1.0.so]]
package ifneeded jpegtcl 9.4.0 \
    [list load [file join $dir libjpegtcl9.4.0.so]]
# -*- tcl -*- Tcl package index file
# --- --- --- Handcrafted, final generation by configure.

package ifneeded img::base 1.4.13 [list load [file join $dir libtkimg1.4.13.so]]
...
package ifneeded img::bmp 1.4.13 \
    [list load [file join $dir libtkimgbmp1.4.13.so]]
package ifneeded img::gif 1.4.13 \
    [list load [file join $dir libtkimggif1.4.13.so]]
package ifneeded img::ico 1.4.13 \
    [list load [file join $dir libtkimgico1.4.13.so]]
package ifneeded img::jpeg 1.4.13 \
    [list load [file join $dir libtkimgjpeg1.4.13.so]]
package ifneeded img::pcx 1.4.13 \
    [list load [file join $dir libtkimgpcx1.4.13.so]]
package ifneeded img::pixmap 1.4.13 \
    [list load [file join $dir libtkimgpixmap1.4.13.so]]
package ifneeded img::png 1.4.13 \
    [list load [file join $dir libtkimgpng1.4.13.so]]
package ifneeded img::ppm 1.4.13 \
    [list load [file join $dir libtkimgppm1.4.13.so]]
package ifneeded img::ps 1.4.13 \
    [list load [file join $dir libtkimgps1.4.13.so]]
package ifneeded img::sgi 1.4.13 \
    [list load [file join $dir libtkimgsgi1.4.13.so]]
package ifneeded img::sun 1.4.13 \
    [list load [file join $dir libtkimgsun1.4.13.so]]
package ifneeded img::tga 1.4.13 \
    [list load [file join $dir libtkimgtga1.4.13.so]]
package ifneeded img::tiff 1.4.13 \
    [list load [file join $dir libtkimgtiff1.4.13.so]]
package ifneeded img::window 1.4.13 \
    [list load [file join $dir libtkimgwindow1.4.13.so]]
package ifneeded img::xbm 1.4.13 \
    [list load [file join $dir libtkimgxbm1.4.13.so]]
package ifneeded img::xpm 1.4.13 \
    [list load [file join $dir libtkimgxpm1.4.13.so]]
package ifneeded img::dted 1.4.13 \
    [list load [file join $dir libtkimgdted1.4.13.so]]
package ifneeded img::raw 1.4.13 \
    [list load [file join $dir libtkimgraw1.4.13.so]]
package ifneeded img::flir 1.4.13 \
    [list load [file join $dir libtkimgflir1.4.13.so]]
