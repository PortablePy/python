...
sub new {
    ...
    $self->{sizer_1}->Add($self->{panel_x}, 1, wxEXPAND, 0);
    ...
    $self->{window_1_pane_1}->SetBackgroundColour(Wx::Colour->new(112, 219, 147));
...
sub new {
    ...
    $self->{window_1_pane_2}->SetBackgroundColour(Wx::Colour->new(35, 142, 35));
