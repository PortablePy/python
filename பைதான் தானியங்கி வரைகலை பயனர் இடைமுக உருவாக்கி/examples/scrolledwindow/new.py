...
#    May 14, 2021 10:15:48 AM PDT  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.geometry("600x450+688+348")
        top.minsize(1, 1)
        top.maxsize(1905, 1050)
        top.resizable(0,  0)
        top.title("Picture Library with Scrolledframe")
        ...
        self.btnExit.place(x=250, y=400, height=30, width=110)
        self.btnExit.configure(activebackground="#d9d9d9")
        self.btnExit.configure(background="wheat")
        self.btnExit.configure(command=new_support.on_btnExit)
        ...
        self.btnExit.configure(text='''Quit''')

        self.Scrolledwindow1 = ScrolledWindow(top)
        self.Scrolledwindow1.place(x=100, y=60, height=325, width=427)
