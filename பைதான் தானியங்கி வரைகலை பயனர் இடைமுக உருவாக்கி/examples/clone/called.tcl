...
#  Oct 05, 2020 07:47:01 AM PDT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top34 {base} {
    ...
    button $top.but34 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {Create Clone} 
    vTcl:DefineAlias "$top.but34" "Button1" vTcl:WidgetProc "Called" 1
    button $top.but35 \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -command lambda:top.destroy() \
        -disabledforeground #b8a786 -font {-family {DejaVu Sans} -size 16} \
        -foreground $vTcl(actual_gui_fg) -highlightbackground #f5f5dedeb3b3 \
        -highlightcolor black -text Close 
    vTcl:DefineAlias "$top.but35" "Button2" vTcl:WidgetProc "Called" 1
    label $top.lab36 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text Label -textvariable instance 
    vTcl:DefineAlias "$top.lab36" "Label1" vTcl:WidgetProc "Called" 1
    button $top.but39 \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text Quit 
    vTcl:DefineAlias "$top.but39" "Button3" vTcl:WidgetProc "Called" 1
    label $top.lab37 \
    ...
    ###################
    place $top.but34 \
        -in $top -x 0 -relx 0.249 -y 0 -rely 0.251 -width 167 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but35 \
        -in $top -x 0 -relx 0.2075 -y 0 -rely 0.78 -width 86 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab36 \
        -in $top -x 0 -relx 0.249 -y 0 -rely 0.553 -width 0 -relwidth 0.454 \
        -height 0 -relheight 0.101 -anchor nw -bordermode ignore 
    place $top.but39 \
        -in $top -x 0 -relx 0.6179 -y 0 -rely 0.78 -width 73 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab37 \
