...
#    May 14, 2021 09:11:09 AM PDT  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1.place(x=130, y=160, height=37, width=147)
        self.Button1.configure(activebackground="#f4bcb2")
        self.Button1.configure(background="wheat")
        self.Button1.configure(command=main_support.open_middle)
        ...
        self.Button2.place(x=170, y=240, height=37, width=67)
        ...
        self.Message1.place(x=148, y=60, height=32, width=97)
