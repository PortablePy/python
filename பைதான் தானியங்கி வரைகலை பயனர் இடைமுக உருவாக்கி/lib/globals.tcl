...
set vTcl(windows)        ".vTcl .vTcl.toolbar .vTcl.ae .vTcl.callback .vTcl.apply
...
# On 3/20/21 I cannot see where any of the following table entries
#other than the function name in the last position is used and then
#only in propmgr.com.  set vTcl(m,wm,prop,geom) { {prop geom} {} \
