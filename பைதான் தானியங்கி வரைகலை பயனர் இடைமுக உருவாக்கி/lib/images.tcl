...
# "
    ...
    foreach image  $used {
        ...
        # set file [vTcl:relTo $file $vTcl(initialdir)]
...
proc vTcl:image:generate_image_user {fileID} {
    ...
    set used $vTcl(dump,userImages)
    #puts $fileID \
            "\#\# Code to generate needed Images see vTcl:save2 in file.tcl\n"
    puts $fileID [vTcl:image:dump_create_image_header $used]

    puts $fileID [vTcl:image:dump_create_image dummy]
    # puts $fileID [vTcl:image:dump_create_image_footer] ;# NEEDS WORK
}
