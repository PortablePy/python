...
##############################################################################
# 20051213 Nelson - rough modifications on this file to get tclets
# operational again.  These modifications seem to mostly work but it
# appears that you should NOT enable or code around "Use widget
# command aliasing" and "Use auto-aliasing for new widgets" features.
# I have left remarks in various places as I sort through the tclet
# operation.

# Doesn't appear to be used in PAGE.  3/7/19

proc vTcl:create_tclet {target} {
    global vTcl
    if {$target == "" ||
        [vTcl:get_class $target] != "Toplevel"} {Lion.100
