...
#    set vTcl(${prefix},pos) [.vTcl.${prefix}_console.tPa42 sashpos 0]
    Window hide $base
    update
    return
}
        ...
        bind $base <Configure> {
            if {$vTcl(creation) == 1} {
                if {$vTcl(gui,pos) == 0} {
                    ...
                    set pos $vTcl(gui,pos)
                }
                .vTcl.gui_console.tPa42 sashpos 0 $pos
                set vTcl(gui,pos) $pos
                set vTcl(creation) 0
            } else {
                set vTcl(gui,pos) [.vTcl.gui_console.tPa42 sashpos 0]
            }
        }
        ...
        bind $base <Configure> {
            if {$vTcl(creation) == 1} {
                if {$vTcl(supp,pos) == 0} {
                    ...
                    set pos $vTcl(supp,pos)
                }
                .vTcl.supp_console.tPa42 sashpos 0 $pos
                set vTcl(supp,pos) $pos
                set vTcl(creation) 0
            } else {
                set vTcl(supp,pos) [.vTcl.supp_console.tPa42 sashpos 0]
            }
        }
...
proc vTcl:style_code {widclass} {
    ...
    "$vTcl(tab2)$vTcl(tab)\[('selected', _compcolor), ('active',_ana2color)\])\n"
            ...
            Scrolledtreeview {
                append vTcl(py_initfunc) \
          "$vTcl(tab2)self.style.configure('Treeview', \
    ...
    switch $widclass {
        ...
        PNotebook {
            ...
            if {$vTcl(pnotebook_count) == 1} {
                ...
                append vTcl(py_initfunc) \
"
$vTcl(tab)$vTcl(tab)global _images
$vTcl(tab)$vTcl(tab)_images = (
    ...
    for {set i 0} {$i<=$entries} {incr i} {
        ...
        switch $type {
            cascade {
                ...
                #vTcl:python_configure_widget $child  $lab_name "" Menu
