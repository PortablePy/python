...
proc vTcl:new_clean_pairs {list {target {}} } {
    ...
    foreach {i val} $list {
        ...
        if {$noencase} {
            ...
            #if {$option eq "-values"} { set encase quote }
            switch $encase {
                list {
                    # set i "$last [list $i] "
...
proc dpr:print_tree {{target ""}} {
    # Debug routine for dumping the tree.
    global vTcl
...
proc vTcl:isident {string  {widget ""}} {
    ...
    # I have decided that this is a bad idea especially since I am
    # going to support Python 3 exclusively; Hence, I am just
    # returning.
    return 1
    global vTcl
