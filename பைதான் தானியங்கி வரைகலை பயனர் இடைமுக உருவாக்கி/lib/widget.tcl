...
proc vTcl:conf_to_pairs {conf opt} {
    ...
    foreach i $conf {
        ...
        if {$opt == "set"} {
            ...
            # obscure usages.
            if {$option eq "-font" && $value ni $vTcl(standard_fonts)} {
        ...
        switch $class {
            PNotebook {
                ...
                [list disabled $vTcl(actual_gui_bg) \
                     selected $vTcl(complement_color)]
...
proc vTcl:place_widget {class button options rx ry x y} {
    ...
    # Must place wudget in a container.
...
proc vTcl:widget:get_tree_label {w} {
    ...
    # name is calculated and returned. In essence I changed
