...
#  -*- coding: utf-8 -*-
#
# Support module generated by PAGE version 4.15d
# In conjunction with Tcl version 8.6
#    Jul 14, 2018 11:53:59 AM
...
def display_buttons():
   ...
   for i in range(num):
      ...
      pict[i] = Button(w.Custom1.inner_frame, image=original,
                       background=bg_color)
      pict[i].image = original
      pict[i].grid(row=n*row, column=col, sticky=W+E+S+N)
      id[pict[i].winfo_id()] = i
      label[i] = Label(w.Custom1.inner_frame, text=date, background=bg_color)
...
def message(event):
    ...
    messagebox.showinfo("Selection", "You selected image: " + str(selected))
