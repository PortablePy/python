...
vTcl:font:add_font \
    "-family {Courier 10 Pitch} -size 14 -weight bold -slant roman -underline 0 -overstrike 0" \
    user \
    vTcl:font3
vTcl:font:add_font \
...
proc vTclWindow.top34 {base} {
    ...
    wm geometry $top 236x263+1242+211
    update
    # set in toplevel.wgt.
    global vTcl
    ...
    ttk::style configure Text -font font1
    text $top.tex35 \
        -background white -font $::vTcl(fonts,vTcl:font3,object) \
        -foreground black -height 186 -highlightbackground wheat \
        -highlightcolor black -insertbackground black \
        -selectbackground {#ddc8a1} -selectforeground black -width 236 \
        -wrap word 
    ...
    button $top.but36 \
        ...
        -command last -disabledforeground {#b8a786} \
        -font $::vTcl(fonts,vTcl:font4,object) -foreground {#000000} \
        -highlightbackground wheat -highlightcolor black -text Last 
    vTcl:DefineAlias "$top.but36" "Button1" vTcl:WidgetProc "Toplevel1" 1
    button $top.cpd37 \
        -activebackground {#f4bcb2} -activeforeground black -background wheat \
        -command current -disabledforeground {#b8a786} \
        -font $::vTcl(fonts,vTcl:font4,object) -foreground {#000000} \
        -highlightbackground wheat -highlightcolor black -text Current 
    vTcl:DefineAlias "$top.cpd37" "Button2" vTcl:WidgetProc "Toplevel1" 1
    button $top.cpd38 \
        -activebackground {#f4bcb2} -activeforeground black -background wheat \
        -command next -disabledforeground {#b8a786} \
        -font $::vTcl(fonts,vTcl:font4,object) -foreground {#000000} \
        -highlightbackground wheat -highlightcolor black -text Next 
