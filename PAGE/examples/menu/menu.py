...
#    May 14, 2021 11:58:17 AM PDT  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.sub_menu1234.add_radiobutton(
                value=1,
                variable=menu_support.selectedButton,
        ...
        self.sub_menu1234.add_radiobutton(
                ...
                foreground="#000000",
                label="Radio-B")
        photo_location = os.path.join(prog_location,"./openfold.gif")
        global _img1
