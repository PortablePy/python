...
#    May 14, 2021 09:01:13 AM PDT  platform: Linux
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    f_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Scrolledwindow1.place(x=180, y=160, height=245, width=237)
