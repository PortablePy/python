...
proc vTclWindow.top37 {base} {
    ...
    button $top.but37 \
        -activebackground {#f4bcb2} -background {#f5deb3} -command start2 \
    ...
    ###################
    place $top.but38 \
        -in $top -x 270 -y 230 -anchor nw -bordermode ignore 
    place $top.but37 \
        -in $top -x 260 -y 100 -anchor nw -bordermode ignore 
