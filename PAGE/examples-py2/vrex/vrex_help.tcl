...
#  Oct 03, 2018 10:55:15 AM PDT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top32 {base} {
    ...
    vTcl:DefineAlias "$top" "Vrex_Help" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.tSc33" "TScrolledtext1" vTcl:WidgetProc "Vrex_Help" 1
    ...
    vTcl:DefineAlias "$top.but34" "Button1" vTcl:WidgetProc "Vrex_Help" 1
    ttk::style configure TSizegrip -background #d9d9d9
    vTcl::widgets::ttk::sizegrip::CreateCmd $top.tSi34 \
        -cursor bottom_right_corner 
    vTcl:DefineAlias "$top.tSi34" "TSizegrip1" vTcl:WidgetProc "Vrex_Help" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tSc33 \
        -in $top -x 20 -y 11 -width 581 -height 561 -anchor nw \
        -bordermode ignore 
    grid columnconf $top.tSc33 0 -weight 1
    grid rowconf $top.tSc33 0 -weight 1
    place $top.but34 \
        -in $top -x 272 -y 582 -width 69 -height 31 -anchor nw \
        -bordermode ignore 
    place $top.tSi34 \
