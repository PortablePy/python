...
#
# Copyright (C) 2021 Donald Rozenberg
#
...
proc vTclWindow.vTcl.apply {args} {
    ...
    # Reset geometry to that saved in the profile.
...
proc Scrolled_EntrySet { canvas } {
    ...
    foreach op $opt {
        ...
        label $f.option$i -text $o
        label $f.value$i -text $v
        checkbutton $f.check$i -pady 0 -variable vTcl(ck,ck$i)
...
proc vTcl:show_apply {} {
    ...
    wm geometry .vTcl.tree $vTcl(default,.vTcl.apply)
    vTcl:init_wtree
}
