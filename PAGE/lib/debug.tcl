...
# dpr variable ...             Prints out the variable name and value.
# dmsg <-s> <args>             Prints out a message. -s causes line skip.
#                              args are text strings, can be $var or calls.
# dtrace                       Prints out call trace.
# dpl list_variable            Prints out list - one element per line.
# dskip <number>               Provide spaces.
