...
def முடிவுகளைஅச்சிடு(தரவு):
    ...
    if "title" in அந்தசாகைபொகு["metadata"]:
        print(அந்தசாகைபொகு["metadata"]["title"])
    ...
    for ஐ in அந்தசாகைபொகு["features"]:
        if ஐ["properties"]["mag"] >= 4.0:
            print("%2.1f" % ஐ["properties"]["mag"], ஐ["properties"]["place"])
    ...
    for ஐ in அந்தசாகைபொகு["features"]:
        ...
        if (உணர்ந்தஅறிக்கைகள் != None):
            if (உணர்ந்தஅறிக்கைகள் > 0):
                print("%2.1f" % ஐ["properties"]["mag"], ஐ["properties"]
...
def முதன்மை():
    ...
    if (வலைஉவி.getcode() == 200):
        ...
        print("சேவையகத்திலிருந்து பிழை பெறப்பட்டது, முடிவுகளை மீட்டெடுக்க முடியாது " +
              str(வலைஉவி.getcode()))
