...
print (timedelta(days=365, hours=5, minutes=1)) #(நாட்கள் = 365, மணிநேரம் = 5, நிமிடங்கள் = 1))

# இன்றைய தேதியை அச்சிடுக
இப்போது = datetime.now ()
print ("இன்று:" + str (இப்போது))

# இப்போதிலிருந்து ஒரு வருடத்தி்ற்கு பிறகு இன்றைய தேதியை அச்சிடுக
print("இப்போதிலிருந்து ஒரு வருடத்தி்ற்கு பிறகு இதுவாக இருக்கும்:" + str (இப்போது + timedelta(days=365)))

# ஒன்றுக்கு மேற்பட்ட வாதங்களைப் பயன்படுத்தும் நேர அட்டவணையை உருவாக்கவும்
print ("இரண்டு வாரங்கள் மற்றும் 3 நாட்களில் இது இருக்கும்:" + str (இப்போது + timedelta(weeks=2, days=3)))
...
print ("ஒரு வாரத்திற்கு முன்பு அது " + சரம்)
...
if சித்திரை <இன்று:
  print ("சித்திரை முட்டாளின் நாள் ஏற்கனவே %d நாட்களுக்கு முன்பு சென்றது"% ((இன்று-சித்திரை). days))
...
print ("இது தான்", சித்திரைக்குநேரம்.days, "அடுத்த சித்திரை முட்டாள்கள் தினம் வரை நாட்கள்!")
