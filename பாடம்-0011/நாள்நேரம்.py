...
def முதன்மை():
    ...
    நாள் = int(இப்போது.strftime("%d"))
    மாதம் = int(இப்போது.strftime("%m"))
    ஆண்டு = int(இப்போது.strftime("%Y"))
    ...
    print("திருவள்ளுவர்ஆண்டு",திருவள்ளுவர்ஆண்டு, ':காலம்',காலம்,":திங்கள்",திங்கள் , )
