...
class TestpGui(object):

    def __init__(self, root_path, src_path):
        """
        Builder Class
        This class controls the GuiBuilder.
        This file is copied to the PROJECTBUILDER folder and retestpd, and then ran whenever a project is created, or
        edited.
    ...
    def command_share(self, testp, command):
        """
        ...
        :param testp: testp of command
        :type testp: str
        :param command: command
        :type command: object
        :return: None
        """
        self.shared[testp] = command
    ...
    @staticmethod
    def make_notebook_tab(self, frame_kwargs, frame_components, frame, tab_testp):
        """
        ...
        :param frame: The testp of the frame
        :type frame: str
        :param tab_testp: The testp of the tab
        :type tab_testp: str
        :return: None
        """
        ...
        self.window.containers[frame].containers['notebook'].add_tab(window, tab_testp)
    ...
    def variable_namify(data):
        """
        Strips out common characters that could be found within potential variable testps
