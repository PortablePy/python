...
class TestGui(object):
    ...
    def __init__(self, root_path, src_path):
        ...
        This file is copied to the PROJECTBUILDER folder and retestd, and then ran whenever a project is created, or
        edited.
    ...
    def command_share(self, test, command):
        """
        ...
        :param test: test of command
        :type test: str
        :param command: command
        :type command: object
        :return: None
        """
        self.shared[test] = command
    ...
    @staticmethod
    def make_notebook_tab(self, frame_kwargs, frame_components, frame, tab_test):
        """
        ...
        :param frame: The test of the frame
        :type frame: str
        :param tab_test: The test of the tab
        :type tab_test: str
        :return: None
        """
        ...
        self.window.containers[frame].containers['notebook'].add_tab(window, tab_test)
    ...
    def variable_namify(data):
        """
        Strips out common characters that could be found within potential variable tests
