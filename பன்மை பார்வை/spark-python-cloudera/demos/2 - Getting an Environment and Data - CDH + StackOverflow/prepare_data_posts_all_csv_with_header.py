...
Or run using
  spark2-submit --packages com.databricks:spark-xml_2.11:0.4.1,com.databricks:spark-csv_2.11:1.5.0 prepare_data_posts_all_csv_with_header.py
...
def main():
    spark = SparkSession.builder.appName("PreparePostsCSVWithHeader").getOrCreate() 
    ...
    postDF.write.format('com.databricks.spark.csv').options(header=True).save('/user/cloudera/stackexchange/posts_all_csv_with_header')
