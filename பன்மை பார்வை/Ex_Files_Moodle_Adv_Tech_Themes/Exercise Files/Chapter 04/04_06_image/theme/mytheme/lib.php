...
function theme_mytheme_process_css($css, $theme) {
    ...
    $css = theme_mytheme_set_logo($css, $logo);
 ...
 */
function theme_mytheme_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 *
 * Do not add My Theme specific logic in here, child themes should be able to
 ...
 */
function theme_mytheme_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
...
/**
 * All theme functions should start with theme_mytheme_
 * @deprecated since 2.5.1
 */
function mytheme_process_css() {
 ...
 * @deprecated since 2.5.1
 */
function mytheme_set_customcss() {
    throw new coding_exception('Please call theme_'.__FUNCTION__.' instead of '.__FUNCTION__);
}
