...
/**
 * Moodle's My Theme theme, an example of how to make a Bootstrap theme
 *
...
if ($ADMIN->fulltree) {
    ...
    $name = 'theme_mytheme/invert';
    $title = get_string('invert', 'theme_mytheme');
    $description = get_string('invertdesc', 'theme_mytheme');
    ...
    $name = 'theme_mytheme/smalllogo';
    $title = get_string('smalllogo', 'theme_mytheme');
    $description = get_string('smalllogodesc', 'theme_mytheme');
    $setting = new admin_setting_configstoredfile($name, $title, $description, 'smalllogo');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $settings->add($setting);

    // Show site name along with small logo.
    $name = 'theme_mytheme/sitename';
    $title = get_string('sitename', 'theme_mytheme');
    $description = get_string('sitenamedesc', 'theme_mytheme');
