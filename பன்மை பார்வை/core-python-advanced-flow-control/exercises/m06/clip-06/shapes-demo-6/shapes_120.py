...
@singledispatch
def intersects_with_rectangle(shape):
    raise TypeError(
...
def _(shape):
    return rectangle_intersects_rectangle(shape)

@intersects_with_rectangle.register(Circle)
def _(shape):
    return rectangle_intersects_circle(shape)

@intersects_with_rectangle.register(Polygon)
def _(shape):
    return rectangle_intersects_polygon(shape)
