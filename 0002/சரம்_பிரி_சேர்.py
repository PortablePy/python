...
அச்சிடு(சரம்)
சரம் = "   தமிழ் ஒரு செம்மொழி - Tamil is a Classical Language   "
அச்சிடு("%%")
...
அச்சிடு(சரம், "சரம்.rjust(100)", சரம்.rjust(100))
அச்சிடு(சரம், "சரம்.ljust(100)", சரம்.ljust(100))
...
அச்சிடு(சரம், "len(சரம்)", len(சரம்))
அச்சிடு(சரம், 'சரம்.encode("UTF-16")', சரம்.encode("UTF-16"))
அச்சிடு(
    b"\xff\xfe\xa4\x0b\xae\x0b\xbf\x0b\xb4\x0b\xcd\x0b",
    "சரம்.decode()",
    b"\xff\xfe\xa4\x0b\xae\x0b\xbf\x0b\xb4\x0b\xcd\x0b".decode("UTF-16"),
)
அச்சிடு(சரம், "சரம்.split()", சரம்.split())
அச்சிடு(சரம், "சரம்.lower()", சரம்.lower())
விலங்குகள் = ["ஆடு", "புலி", "சிங்கம்", "மாடு", "பூனை"]
அச்சிடு(விலங்குகள், "''.join(விலங்குகள்)", "".join(விலங்குகள்))
அச்சிடு(சரம், "சரம்.find('Tamil')", சரம்.find("Tamil"))
அச்சிடு(சரம், "சரம்.lstrip()", சரம்.lstrip())
அச்சிடு(சரம், "சரம்.strip()", சரம்.strip())
அச்சிடு(சரம், "சரம்.rstrip()", சரம்.rstrip())
